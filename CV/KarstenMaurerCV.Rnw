...
Ph.D., Statistics, August 2015 
\newline Iowa State University, Ames IA  \\ [.25cm]
M.S., Statistics, December 2011
\newline Iowa State University, Ames IA  \\ [.25cm]
B.A., Statistics and History, May 2009  
\newline Minor in Mathematics, Graduated with Distinction 
\newline University of Minnesota Morris, Morris MN 
...
\item STA 467/567, Statistical Learning (3 Section)
\item STA 477/480/600, Independent Studies in Statistics (12 students)
...
% 
% \begin{itemize} \itemsep -2pt % Reduce space between items
%   \item	Travis Sellers – Spring 2016 – Data Visualization (3 credits)
%   \item	Rey Ducay – Spring & Summer 2016 – Statistical Programming (3 credits)
%   \item	Gongmei Li – Summer 2017 to Present – Variable Selection (6 credits)
%   \item	David Swart – Fall 2017 to Spring 2018 – Stat Education Research (3 credits)
%   \item	Stefan Nguyen – Spring 2018 – Interactive Data Visualizations (1 credits) 
%   \item	Matt Misterka – Spring 2019 – Stat Education Research (3 credits)
%   \item	Yuexi Wang – Summer 2017 to Spring 2018 – Ensemble Classifiers (6 credits) 
%   \item	Alison Tuiyott – Present – Data Expo Project Leadership (1 credit) 
%   \item	Ben Schweitzer – Present – Data Expo Project Leadership (1 credit)
%   \item	Robert Garrett – Spring 2018 – STA 467 Undergraduate Associate (1 credits) 
%   \item	Amy Underwood –Summer 2016 – Graduate Research Assistant at AFRL
%   \item	Michael Creutzinger – Spring 2018 – graduate research discussions
% \end{itemize}
...
\textbf{Maurer K.} Hudiburgh L., Werwinski L., Bailer A.J., (2019) \href{https://www.tandfonline.com/doi/pdf/10.1080/00031305.2018.1537890?needAccess=true}{\it Content Audit for P-value Principles in Introductory Statistics} (The American Statistician -- 2800+ views, 2 citations)
...
Garrett R.*, Nar A.*, Fisher T., \textbf{Maurer K.}, (2018) \href{https://www.theoj.org/joss-papers/joss.01096/10.21105.joss.01096.pdf}{\it ggvoronoi: Voronoi Diagrams and Heatmaps with ggplot2} (Journal of Open Source Software, 3(32) -- 8000+ package downloads from CRAN) 
...
\textbf{Maurer K.}, Lock D. (2016), \href{http://escholarship.org/uc/item/0wm523b0}{{\it Comparison of Learning Outcomes for Randomization-Based and Traditional Inference Curricula in a Designed Educational Experiment}} (Technology Innovations in Statistics Education, Volume 8 -- 1400+ views, 400+ downloads, 8 citations)

Anderson J., Burks S., Carpenter J., Goette L., \textbf{Maurer K.}, Nosenzo D., Potter R., Rocha K., Rustichini A., (2013) \href{https://link.springer.com/article/10.1007/s10683-012-9327-7}{{\it Self-selection and variations in the laboratory measurement of other-regarding preferences across subject pools: evidence from one college student and two adult samples}} (Experimental Economics, 16(2) -- 1200+ downloads)
...
\textbf{Maurer K.}, Bennette W., \textit{Facility Locations Utility for Uncovering Classifier Overconfidence} (International Conference on Machine Learning and Applications** - {\it accepted pending minor revision} )

\textbf{Maurer K.}, Hudiburgh L., Werwinski L., \textit{What do Students Gain from Games? Dice Game vs. Word Problems} (Teaching Statistics - {\it under second round of review})
...
Bennette W., \textbf{Maurer K.}, Sisti S. \textit{Harnessing Adversarial Distances to Uncover Overconfident Unknown Unknowns} (Winter Conference on Applications of Computer Vision** - {\it submitted}) 

\hspace{0cm} **Conference manuscripts undergoing competitive, blinded peer review process \\
...
{\bf Schweitzer B.*}, Fisher T., \textbf{Maurer K.}, {\bf Tuiyott A.*}, {\bf Carter L.*}, {\bf Garrett R.*}, {\it An Analysis of Rent Control Impact on New York City Housing Quality}. (2$^{nd}$ Place ASA Data Expo Challenge Invited Paper)

{\bf Tuiyott A.*}, \textbf{Maurer K.}, Fisher T., {\bf Schweitzer B.*}, {\bf Carter L.*}, {\bf Garrett R.*}, {\it Mapping Immigrant Residency and Happiness in New York City}. (3$^{rd}$ Place ASA Data Expo Challenge Invited Paper)

Bennette W., \textbf{Maurer K.}, Sisti S., {\bf Dufek S.*}, {\bf Tusmatov B.*}, {\it Generalizations of Adversarial Distance in Identification of Unknown Unknowns}

{\bf Swart D.*}, Hudiburgh L., \textbf{Maurer K.}, Smucker B., {\it Comparing Instructor Created vs. Externally Created Homework Assignments And Their Effects On Exam Scores} 

{\bf Garrett R.*}, Fisher T., \textbf{Maurer K.}, {\it Voronoi Applications in Data Science}
...
Scarborough D., \textbf{Maurer K.}, Bailey-Van Kuren M., {\bf Pax L.*}, {\bf Summerford M.*}, {\it Evaluating Baby Food Manufacturer Stages Through IDSSI Protocol}  \\
...
{\it Team Mentor}, \href{https://miamioh.edu/fsb/centers/cads/experiential-learning/projects/index.html}{CADS Undergrad Experiential Learning Client Project}  \hfill Fall 2019 \\
