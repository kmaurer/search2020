...
Baseline algorithm comparison are indirect

Can't use the utilities on which the query algorithms optimize without clear bias
...
Performs similar to Most-Uncertain query when classifier overconfidence is worst in moderately confidence instances

Outperforms all previous methods when classifier overconfidence is worst in highest confidence instances 
